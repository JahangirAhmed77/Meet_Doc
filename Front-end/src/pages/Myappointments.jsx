    ...
    <div>
      ...
      <div>
        {appointments.map((item, index) => (
          ...
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-4 py-2 border-b' key={index}>
            <div>
            ...
            <div className='flex-1 text-sm text-zinc-600 pl-4 pt-1'>
              ...
              <p className='text-sm mt-1 '>
                ...
                {item.slotDate ? slotDateFormat(item.slotDate) : 'N/A'} | {item.slotTime || 'Time not available'}
              </p>
            </div>
